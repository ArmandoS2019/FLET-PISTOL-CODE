...
class MySnackBar:
    ...
    def snackbar_read_qrbarcode(self, e, message):
        self.page.snack_bar = ft.SnackBar(content=ft.Text(str(message)),action="Alright!")
        
        self.page.snack_bar = ft.SnackBar(ft.Text(self.page.client_storage.get("username").lower()))
